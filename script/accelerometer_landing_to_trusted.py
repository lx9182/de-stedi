...
AmazonS3_node1683604534307 = glueContext.create_dynamic_frame.from_options(
    format_options={"multiline": False},
    connection_type="s3",
    format="json",
    connection_options={
    ...
    transformation_ctx="AmazonS3_node1683604534307",
)

# Script generated for node Customer Privacy Filter
CustomerPrivacyFilter_node2 = Join.apply(
    frame1=S3bucket_node1,
    frame2=AmazonS3_node1683604534307,
    keys1=["user"],
    keys2=["email"],
...
S3bucket_node3 = glueContext.write_dynamic_frame.from_options(
    ...
    format="json",
    connection_options={
        "path": "s3://binh-stedi-lakehouse/accelerometer/trusted/",
        "partitionKeys": [],
    },
